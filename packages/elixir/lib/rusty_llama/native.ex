defmodule RustyLlama.Native do
  ...
  def model_bos_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_cls_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_eos_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_eot_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_fim_mid_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_fim_pad_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_fim_pre_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_fim_rep_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_fim_sep_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_fim_suf_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_mask_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_nl_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_pad_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  def model_sep_token(_model), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def sequence_remove(_sequence, _start, _stop), do: :erlang.nif_error(:nif_not_loaded)
  def sequence_kv_remove(_sequence, _start, _stop), do: :erlang.nif_error(:nif_not_loaded)
  def sequence_kv_shift(_sequence, _start, _stop, _delta), do: :erlang.nif_error(:nif_not_loaded)
  def sequence_copy_to(_sequence, _other, _start, _stop), do: :erlang.nif_error(:nif_not_loaded)
  def sequence_copy_from(_sequence, _other, _start, _stop), do: :erlang.nif_error(:nif_not_loaded)
  def sequence_kv_copy(_sequence, _other, _start, _stop), do: :erlang.nif_error(:nif_not_loaded)
end
